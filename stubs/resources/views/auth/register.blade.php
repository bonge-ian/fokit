		...
		<div class="uk-margin">
			...
			<div class="uk-width-1-1">
				<div class="uk-inline uk-width-1-1">
					...
					<input class="uk-input @error('name') uk-form-danger  @enderror" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" />
				</div>
		...
		<div class="uk-margin">
			...
			<div class="uk-width-1-1">
				<div class="uk-inline uk-width-1-1">
					...
					<input class="uk-input @error('email') uk-form-danger  @enderror" type="email" name="email" value="{{ old('email') }}" required />
				</div>
		...
		<div class="uk-margin">
			...
			<div class="uk-width-1-1">
				<div class="uk-inline uk-width-1-1">
					...
					<input class="uk-input @error('password_confirmation') uk-form-danger  @enderror" type="password" name="password_confirmation" required autocomplete="new-password" />
				</div>
